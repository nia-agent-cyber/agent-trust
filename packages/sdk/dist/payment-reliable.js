...
exports.normalizeTimestampToSeconds = normalizeTimestampToSeconds;
exports.normalizePaymentReliableRequest = normalizePaymentReliableRequest;
exports.encodePaymentReliableAttestation = encodePaymentReliableAttestation;
exports.parsePaymentOutcome = parsePaymentOutcome;
exports.emptyEvidenceHash = emptyEvidenceHash;
const eas_sdk_1 = require("@ethereum-attestation-service/eas-sdk");
const constants_1 = require("./constants");
const ZERO_BYTES32 = `0x${'0'.repeat(64)}`;
const PAYMENT_OUTCOME_TO_CODE = {
    defaulted: 0,
    paid_late: 1,
    paid_on_time: 2,
};
const PAYMENT_CODE_TO_OUTCOME = {
    0: 'defaulted',
    1: 'paid_late',
    2: 'paid_on_time',
};
...
function normalizePaymentReliableRequest(request) {
...
function encodePaymentReliableAttestation(request) {
    const normalized = normalizePaymentReliableRequest(request);
    const schemaEncoder = new eas_sdk_1.SchemaEncoder(constants_1.SCHEMAS.paymentReliable.schema);
...
function parsePaymentOutcome(code) {
