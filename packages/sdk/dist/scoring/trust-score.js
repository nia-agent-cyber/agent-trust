...
exports.getDefaultTrustScore = getDefaultTrustScore;
/**
...
function calculateTrustScore(inputs) {
    ...
    const confidence = calculateConfidence(activeVerifications.length, activeVouches.length, activeFlags.length, [...activeVerifications, ...activeVouches, ...activeFlags]);
 ...
 */
function calculateVouchBonus(vouches, attesterScores) {
    if (vouches.length === 0)
        return 0;
 ...
 */
function calculateFlagPenalty(flags, attesterScores) {
    if (flags.length === 0)
        return 0;
 ...
 */
function calculateConfidence(verificationCount, vouchCount, flagCount, allAttestations) {
