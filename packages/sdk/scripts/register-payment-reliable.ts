 ...
 * Run with: PRIVATE_KEY=<key> npx ts-node scripts/register-payment-reliable.ts
 */
...
async function main() {
  ...
  console.log('🚀 Registering PaymentReliable schema on Base Sepolia...\n');
