/**
 * Register SecurityAudit schema on Base Sepolia
 * Run with: PRIVATE_KEY=<key> npx ts-node scripts/register-security-audit.ts
 */
...
async function main() {
  ...
  console.log('🚀 Registering SecurityAudit schema on Base Sepolia...\n');
